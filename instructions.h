...
typedef struct _code_attr code_attr;

extern char *instr_str[];
extern int static_instr_size[];

extern char *instr_string(unsigned short int);
extern int get_instr_size(code_attr *, int);
